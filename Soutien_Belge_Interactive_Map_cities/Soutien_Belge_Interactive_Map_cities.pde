...
void setup() {
  ...
  belgium = new Country(loadImage("belgium.png"), false, false, new City[]{brussels}, yel);
  levant = new Country(loadImage("middleeast.png"), false, false, new City[]{beirut, arsal, damascus, aleppo, kilis, amman}, gre, blu, pin, cya);
